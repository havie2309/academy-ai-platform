...
ETL_INTERNAL_AUTH_HEADER = os.getenv("ETL_INTERNAL_AUTH_HEADER", "x-etl-internal-secret").strip()
ETL_INTERNAL_SHARED_SECRET = os.getenv("ETL_INTERNAL_SHARED_SECRET", "").strip()
