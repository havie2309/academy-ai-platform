...
export class ChatCacheService {
  ...
  // ============================================================
  // Session Context (for multi-turn chat)
  // ============================================================
  ...
  async setSessionContext(sessionId: string, context: any, ttl = 3600): Promise<void> {
    const key = `${this.PREFIX}session:${sessionId}`;
  ...
  async incrementRateLimit(userId: string, limit = 60, window = 60): Promise<number> {
