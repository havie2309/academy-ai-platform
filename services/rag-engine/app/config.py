...
# --- Exercises (J-02) ---------------------------------------------------------
EXERCISE_MAX_CHARS = int(os.getenv("EXERCISE_MAX_CHARS", "2000"))
EXERCISE_LLM_PROVIDER = os.getenv("EXERCISE_LLM_PROVIDER", LLM_PROVIDER).strip().lower()
EXERCISE_LLM_BASE_URL = os.getenv("EXERCISE_LLM_BASE_URL", LLM_BASE_URL).strip()
EXERCISE_LLM_MODEL = os.getenv("EXERCISE_LLM_MODEL", LLM_MODEL).strip()
EXERCISE_LLM_FALLBACK_PROVIDER = (
    os.getenv("EXERCISE_LLM_FALLBACK_PROVIDER", LLM_FALLBACK_PROVIDER).strip().lower()
)
EXERCISE_LLM_FALLBACK_BASE_URL = (
    os.getenv("EXERCISE_LLM_FALLBACK_BASE_URL", LLM_FALLBACK_BASE_URL).strip()
)
EXERCISE_LLM_FALLBACK_MODEL = (
    os.getenv("EXERCISE_LLM_FALLBACK_MODEL", LLM_FALLBACK_MODEL).strip()
)
EXERCISE_LLM_RETRY_ATTEMPTS = int(os.getenv("EXERCISE_LLM_RETRY_ATTEMPTS", "2"))
EXERCISE_LLM_TIMEOUT = float(os.getenv("EXERCISE_LLM_TIMEOUT", "90"))
