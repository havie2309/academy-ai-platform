...
DOCUMENT_TYPES = [
    {"type": "pdf_text", "category": "giao_trinh", "name": "Giáo trình"},
    {"type": "pdf_text", "category": "giao_trinh", "name": "Bài giảng"},
    {"type": "pdf_text", "category": "tai_lieu_tham_khao", "name": "Tài liệu tham khảo"},
    {"type": "docx", "category": "quy_che", "name": "Quy chế"},
    {"type": "docx", "category": "nghien_cuu", "name": "Nghiên cứu"},
    {"type": "docx", "category": "luan_van", "name": "Luận văn"},
    {"type": "docx", "category": "de_cuong", "name": "Đề cương môn học"},
    {"type": "txt", "category": "bai_giang", "name": "Bài giảng"},
    {"type": "txt", "category": "quy_dinh", "name": "Quy định"},
    {"type": "txt", "category": "noi_quy", "name": "Nội quy"},
]
...
def generate_pdf_text(doc_info, output_dir):
    ...
    if doc_info['category'] == 'quy_che':
        content = generate_quy_dinh_content()
    elif doc_info['category'] == 'nghien_cuu':
        content = generate_research_content()
    elif doc_info['category'] == 'luan_van':
...
def generate_docx(doc_info, output_dir):
    ...
    elif doc_info["category"] == "quy_che":
...
def generate_txt(doc_info, output_dir):
    ...
    if doc_info["category"] in ["noi_quy", "quy_dinh"]:
...
"""
    ...
    for i, doc_info in enumerate(documents):
        ...
        if doc_info['category'] in ['quy_che', 'luan_van']:
            security_level = 'restricted'
        elif doc_info['category'] in ['nghien_cuu']:
    ...
    "storagePath": "/app/data/uploads/{doc_info['doc_id']}.{file_ext}",
    "mimeType": "{mime_type}",
