...
-- role_category_policies - Ma trận quyền Role × Category
...
CREATE TABLE role_category_policies (
    ...
    category_code VARCHAR(50) REFERENCES data_categories(category_code) ON DELETE CASCADE,
    allow_read    BOOLEAN DEFAULT FALSE,
    allow_write   BOOLEAN DEFAULT FALSE,
    dept_scope    VARCHAR(20) DEFAULT 'all' CHECK (dept_scope IN ('all', 'own_department')),
